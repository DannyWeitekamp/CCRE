...
void init_var(nb::module_ & m){
    ...
    .def("__ne__", [](Var* self, nb::handle other){return new_literal(Equals(self, Item_from_py(other)), true);}, nb::rv_policy::reference)
    .def("__lt__", [](Var* self, nb::handle other){return (ref<Func>) LessThan(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__gt__", [](Var* self, nb::handle other){return (ref<Func>) GreaterThan(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__le__", [](Var* self, nb::handle other){return (ref<Func>) LessThanOrEqual(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__ge__", [](Var* self, nb::handle other){return (ref<Func>) GreaterThanOrEqual(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__add__", [](Var* self, nb::handle other){return (ref<Func>) Add(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__radd__", [](Var* self, nb::handle other){return (ref<Func>) Add(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__sub__", [](Var* self, nb::handle other){return (ref<Func>) Subtract(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__rsub__", [](Var* self, nb::handle other){return (ref<Func>) Subtract(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__mul__", [](Var* self, nb::handle other){return  (ref<Func>) Multiply(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__rmul__", [](Var* self, nb::handle other){return  (ref<Func>) Multiply(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__truediv__", [](Var* self, nb::handle other){return  (ref<Func>) Divide(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__rtruediv__", [](Var* self, nb::handle other){return  (ref<Func>) Divide(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__floordiv__", [](Var* self, nb::handle other){return  (ref<Func>) FloorDivide(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__rfloordiv__", [](Var* self, nb::handle other){return  (ref<Func>) FloorDivide(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__mod__", [](Var* self, nb::handle other){return  (ref<Func>) Modulo(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__rmod__", [](Var* self, nb::handle other){return  (ref<Func>) Modulo(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__pow__", [](Var* self, nb::handle other){return  (ref<Func>) Pow(self,Item_from_py(other));}, nb::rv_policy::reference)
    .def("__rpow__", [](Var* self, nb::handle other){return  (ref<Func>) Pow(Item_from_py(other),self);}, nb::rv_policy::reference)
    .def("__neg__", [](Var* self){return  (ref<Func>) Negate(self);}, nb::rv_policy::reference)
